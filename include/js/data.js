...
const evolution = ['Stade 1', 'Stade 2','Stade 3']
const Poids = ['Léger', 'Moyen','Lourd']
const tailles = ['Petit','Moyen','Grand']
const description_Types = {
  "Eau" : "Les Pokémon de type Eau ont une couverture offensive assez neutre, d'autant plus que leur puissance est réduite de moitié lors d'une exposition au soleil. Ils sont associés à la pluie.",
  "Combat" : " Les Pokémon de type Combat montrent leur plein potentiel dans la force brut, ayant des dispositions en attaque qui surpassent la moyenne.",
  "Sol" : "Les Pokémon de type Sol possèdent la meilleure couverture offensive, en étant plus compétents en attaque et en défense qu'en vitesse et en spécial.",
  "Glace" : "Les Pokémon de type Glace sont habitués aux faibles températures. C'est le plus mauvais type défensif du jeu.",
  "Psy" : " Les Pokémon de type Psy regroupent tous les Pokémon aillant des pouvoirs mentaux. Ils possèdent une intelligence et une force hors du commun.",
  "Poison" : " Les Pokémon de type Poison se remarquent pour leurs capacités défensives plus qu'offensives. Ils sont associés au venin et à la toxicité.",
  "Feu" : "Les Pokémon de type Feu sont offensifs et plus forts en présence de soleil. Ils sont également les deuxièmes plus résistant derrière l'Acier.",
  "Dragon" : "Les Pokémon de type Dragon sont rares, ils sont neutres offensivement et faibles face aux types Acier et Fée.",
  "Roche" : "Les Pokémon de type Roche se montrent très faibles en vitesse de par leur poids excessif. Ils se remarquent par leur résistance hors normes.",
  "Normal" : "Les Pokémon de type Normal sont les Pokémon par défaut, ils sont défensivement les plus neutres et restent modestes. Mais ils comptent beaucoup de Pokémon à haute vitalité.",
  "Fée" : "Les Pokémon de type Fée se montrent efficaces face au type Dragon, mais également aux types Ténèbres et Combat. Malgré tout, ce type est faible en offensive.",
  "Insecte" : "Les Pokémon de type Insecte ne se distinguent pas pour leurs capacités offensives et de défense, mais plutôt pour leur combinaison avec d'autres types.",
  "Plante" : "Les Pokémon de type Plante tirent leurs pouvoirs du règne végétal. C'est le seul type à dominer simultanément les types Eau et Sol.", 
  "Spectre" : "Les Pokémon de type Spectre sont associés à tout ce qui touche aux fantômes et au paranormale. Ils sont très efficaces contre deux types dont le sien, mais faibles en défense.", 
  "Vol" : "Les Pokémon de type Vol sont les Pokémon qui se déplacent dans les airs avec beaucoup d'aisance, utilisant principalement le vent. Ils ne sont pas réputés pour leur défense, et sont insensibles aux attaques terrestres.",
  "Électrik" : "Les Pokémon de type Electrik ne sont pas connus pour leur défense, mais au contraire pour leur vitesse qui leur permet des capacités d'attaque exceptionnelles.",
  "Acier" : "Les Pokémon de type Acier sont faits de métaux. C'est le meilleur type défensif, ce qui implique plus de lenteur. Il est d'ailleurs immunisé face au type Poison."
 }
const data = [
  {
    "nom": "Bulbizarre",
